...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--pre_path', default='bert-base-chinese')
    ...
    arg_parser.add_argument('--dropout', default=0.2, type=float, help='feature dropout rate')
    arg_parser.add_argument('--embed_size', default=768*4, type=int, help='Size of word embeddings')
    arg_parser.add_argument('--hidden_size', default=1024, type=int, help='hidden size')
    arg_parser.add_argument('--num_layer', default=2, type=int, help='number of layer')
    arg_parser.add_argument('--test_batch_size', default=1, type=int, help='Testing Batch size')
